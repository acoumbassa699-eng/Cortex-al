...
const Brand = ({ className = '' }) => <span className={`brand ${className}`}><img className="brand-logo" src="/cortex-logo.svg" alt="Cortex"/><span>Cortex</span></span>;
...
function App() {
  ...
  return <div className="app">
    ...
    </main><footer className="footer container"><Brand /><span>© 2026 Cortex. Built for builders.</span><div><a href="#privacy">Privacy</a><a href="#terms">Terms</a><a href="#docs">Docs</a></div></footer>
  </div>;
}
